...
**Spacebar — wave surge:** Pressing spacebar triggers a smooth boost that immediately lowers the wave amplitude, making all waves dip down together. The effect then decays smoothly over ~2 seconds as the waves return to their normal height.
...
5. **Surge the waves** — press the **spacebar** to make all waves dip down together. They return to their normal height smoothly over roughly 2 seconds.
